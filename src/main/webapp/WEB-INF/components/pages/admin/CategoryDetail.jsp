...
<% request.setAttribute("page_name", "Admin Category Detail"); %>
...
<head>
  ...
  <title>${single.name} | Admin - Wiki Portal</title>
  ...
  <div id="${page_name}" class="wrapper">
    ...
    <main>
      <section style="max-width: 114rem; min-height: calc(100vh - 28.6rem); margin: 0 auto; padding-top: 12rem;">
        <h2 class="section__heading" style="margin-bottom: 2.4rem;">${mode == 'create' ? 'Create New Category' : 'Category Detail'}</h2>
        <%@ include file="../../layouts/forms/CategoryDetailForm.jsp" %>
      </section>
    </main>
